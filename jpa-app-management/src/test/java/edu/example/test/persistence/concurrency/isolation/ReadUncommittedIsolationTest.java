 ...
 * query parameter ?sessionVariables=transaction_isolation='READ-UNCOMMITTED'
 */
public class ReadUncommittedIsolationTest extends IsolationLevelBaseTest {

//    @Test
    public void shouldDirtyReadHappen() {
        // given
        ...
        doInJPA(entityManagerFactorySupplier, entityManager -> {
            ...
            assertEquals(bobDummy.getValue(), "Changed by Alice");
        });
    }
...
//    @Test
    public void shouldNonRepeatableReadHappen() {
        ...
        doInJPA(entityManagerFactorySupplier, alice -> {
            ...
            assertNotEquals(1, aliceDummy.getCountDown());
        });
    }

//    @Test
    public void shouldPhantomReadHappen() {
        // given
        ...
        doInJPA(entityManagerFactorySupplier, bob -> {
            ...
            bobDummies = bob.createQuery("SELECT dummy FROM Dummy dummy WHERE dummy.countDown = :countDown")
                    .setParameter("countDown", countDownCondition)
                    .getResultList();
            assertNotEquals(3, bobDummies.size());
        });
    }
